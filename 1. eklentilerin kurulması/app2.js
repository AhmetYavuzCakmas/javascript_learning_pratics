/*
let kitap1 = {isim:"her şeyi düşünme",fiyat:25,raf:"1.5. RAF"};
let kitap2 = {isim:"hiç bir karşılaşma tesadüf ",fiyat:35,raf:"2.2. RAF"};
let kitap3 = {isim:"insan neyle yaşar",fiyat:41,raf:"3.4. RAF"};
let kitap4 = {isim:"zafer sızlanmaz",fiyat:15,raf:"4.3. RAF"};
let kitap5 = {isim:"şeker portakalı",fiyat:47,raf:"5.5. RAF"};
...
*/
 let yazi =" Modern Web Geliştirme Kursu"; 
 //console.log(yazi.trim()); // trim baştaki ve sondaki boşlukları siler
/*let dizi = yazi.split("e");
console.log(dizi);
*/
